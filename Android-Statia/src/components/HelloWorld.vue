              ...
              <div id="pitch">
                ...
                <div id = "matchScreen">
                  ...
                  <div id="middle" v-if="liveKPIs=='no'">
                    <img id="pitchSVG" src="../../static/pitch.svg">
                    <div id="player">
  ...
  export default {
    ...
    data: function() {
      return {
        ...
        team: '',
        items: [
          { region: 'Dingles Third' },
          { region: 'Middle' },
          { region: 'St Marys Third' },
        ],
        playerKPITitles:[],
        active: '',
        squadmembers: [
          { player_name: 'Mike Daly',
            position: 'GK',
            squad_number: '1',
            player_id: '1'
          },
          { player_name: 'Oisin Moran',
            position: 'RCB',
            squad_number: '2',
            player_id: '2'
          },
          { player_name: 'Brian Curran',
            position: 'FB',
            squad_number: '3',
            player_id: '3'
          },
          { player_name: 'Patrick Cournane',
            position: 'LCB',
            squad_number: '4',
            player_id: '4'
          },
          { player_name: 'Adam Quirke',
            position: 'RWB',
            squad_number: '5',
            player_id: '5'
          },
          { player_name: 'Darragh OSullivan',
            position: 'CB',
            squad_number: '6',
            player_id: '6'
          },
          { player_name: 'Conor OShea',
            position: 'LWB',
            squad_number: '7',
            player_id: '7'
          },
          { player_name: 'Denis Daly',
            position: 'M1',
            squad_number: '8',
            player_id: '8'
          },
          { player_name: 'Bryan Sheehan',
            position: 'M2',
            squad_number: '9',
            player_id: '9'
          },
          { player_name: 'Aidan Walsh',
            position: 'RWF',
            squad_number: '10',
            player_id: '10'
          },
          { player_name: 'Paul ODonoghue',
            position: 'CF',
            squad_number: '11',
            player_id: '11'
          },
          { player_name: 'Jack Daly',
            position: 'LWF',
            squad_number: '12',
            player_id: '12'
          },
          { player_name: 'Sean Cournane',
            position: 'LCF',
            squad_number: '13',
            player_id: '13'
          },
          { player_name: 'Dan Daly',
            position: 'FF',
            squad_number: '14',
            player_id: '14'
          },
          { player_name: 'Anthony Cournane',
            position: 'RCF',
            squad_number: '15',
            player_id: '15'
          },
        ...
        left:[
          {
            kpi_id: 1,
            kpi_title: 'Black Card',
          },
          {
            kpi_id: 2,
            kpi_title: 'Yellow Card',
          },
          {
            kpi_id: 3,
            kpi_title: 'Point From Play',
          },
          {
            kpi_id: 4,
            kpi_title: 'Goal From Play',
          },
          {
            kpi_id: 5,
            kpi_title: 'Point From Set Piece',
          },
          {
            kpi_id: 6,
            kpi_title: 'Goal From Set Piece',
          },
          {
            kpi_id: 7,
            kpi_title: 'Wide From Point Attempt',
          },
          {
            kpi_id: 8,
            kpi_title: 'Wide From Goal Attempt',
          },
        ],
        right: [
          {
            kpi_id: 9,
            kpi_title: 'Goal Save By GoalKeeper',
          },
          {
            kpi_id: 10,
            kpi_title: 'Point Attempt Dropped Short',
          },
          {
            kpi_id: 11,
            kpi_title: 'Turnover',
          ...
          {
            kpi_id: 12,
            kpi_title: 'Foul Committed',
          },
          {
            kpi_id: 13,
            kpi_title: 'Clean Catch From Kickout',
          },
          {
            kpi_id: 14,
            kpi_title: 'Breaking Ball Win from Kick Out',
          },
          {
            kpi_id: 15,
            kpi_title: 'Successful Short Kickout',
          },
          {
            kpi_id: 16,
            kpi_title: 'Unforced Error',
          },
        ],
        team_name: 'St Marys',
        opposition: 'Dingle',
    ...
    methods: {
      ...
      calculateScore() {
        ...
        if ((this.kpiCollectedID == 5 || this.kpiCollectedID == 5) && this.teamCollectedID == this.match[0].teamAway_id) {
          this.awayPoints++
        }
